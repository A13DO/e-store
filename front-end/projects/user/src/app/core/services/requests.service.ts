...
getDbCart(): Observable<Product[]> {
  ...
  getAll(search?: string, category?: string, sortOption?: string, numericFilter?: string, limit?: number) {
  ...
  getAllCategories() {
    return this.http.get<{ success: boolean, data: Product[] }>(`https://e-commerce-api-wvh5.onrender.com/api/v1/categories`)
    .pipe(map((res)=> res.data))
  }

  addNewCategory(category: string) {
    return this.http.post<any>(`https://e-commerce-api-wvh5.onrender.com/api/v1/categories`, {
      category: category
    })
  }
  ...
  getComments(productID: any) {
    return this.http.get<any>(`https://e-commerce-api-wvh5.onrender.com/api/v1/comments/${productID}`)
  }
  getOneComment(productID: any, uid: any) {
    return this.http.get<any>(`https://e-commerce-api-wvh5.onrender.com/api/v1/comments/${productID}/${uid}`)
  }
  saveComment(productID: string, body: any): Observable<any> {
    console.log(productID, body);
    localStorage.setItem("commentExists", "true")
    return this.http.post<any>(`https://e-commerce-api-wvh5.onrender.com/api/v1/comments/${productID}`, body)
  }

  updateComment(productID: any, uid: any, body: any) {
    console.log(body);

    return this.http.put<any>(`https://e-commerce-api-wvh5.onrender.com/api/v1/comments/${productID}/${uid}`, body)
  }
