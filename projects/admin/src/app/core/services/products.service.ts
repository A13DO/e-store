...
export class ProductsService {
  ...
  createProduct(body: any, arrayOfFiles: File[]) {
    ...
    this.http.post<any>(`https://e-commerce-api-wvh5.onrender.com/api/v1/products`, fd).subscribe(
      res => {
        console.log(res);
      }, err => {
        console.log(err);
  ...
  updateProduct(id: string, body: any) {
    ...
    this.http.patch(`https://e-commerce-api-wvh5.onrender.com/api/v1/products/${id}`, fd).subscribe(
      res => {
        console.log(res);
      }
    )
